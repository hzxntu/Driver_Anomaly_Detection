...
class RES_BL_CL(nn.Module):
    def __init__(self):
        super(RES_BL_CL, self).__init__()
        ...
        '''
        self.fc=nn.Sequential(nn.Linear(512, 1),
                              #nn.ReLU(inplace=True),
                              #nn.Linear(256, 1),
                             )
        #self.head=resnet_dad.ProjectionHead(output_dim=128,model_depth=18)
